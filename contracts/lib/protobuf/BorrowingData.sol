...
library BorrowingCompleteProperties {


  //struct definition
  struct Data {
    IssuanceProperties.Data issuanceProperties;
    BorrowingProperties.Data borrowingProperties;
  }
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    BorrowingProperties.store(input.borrowingProperties, output.borrowingProperties);
