...
library LendingData {
   ...
   * @return The number of bytes decoded
   */
  function _read_lendingTokenAddress(uint p, bytes memory bs, Data memory r, uint[10] memory counters) internal pure returns (uint) {
    /**
     * if `r` is NULL, then only counting the number of fields.
     */
    (address x, uint sz) = ProtoBufRuntime._decode_sol_address(p, bs);
   ...
   * @return The number of bytes decoded
   */
  function _read_lendingAmount(uint p, bytes memory bs, Data memory r, uint[10] memory counters) internal pure returns (uint) {
    /**
     * if `r` is NULL, then only counting the number of fields.
     */
    (uint256 x, uint sz) = ProtoBufRuntime._decode_sol_uint256(p, bs);
   ...
   * @return The number of bytes decoded
   */
  function _read_collateralRatio(uint p, bytes memory bs, Data memory r, uint[10] memory counters) internal pure returns (uint) {
    /**
     * if `r` is NULL, then only counting the number of fields.
     */
    (uint256 x, uint sz) = ProtoBufRuntime._decode_sol_uint256(p, bs);
   ...
   * @return The number of bytes decoded
   */
  function _read_engagementDueTimestamp(uint p, bytes memory bs, Data memory r, uint[10] memory counters) internal pure returns (uint) {
    /**
     * if `r` is NULL, then only counting the number of fields.
     */
    (uint256 x, uint sz) = ProtoBufRuntime._decode_sol_uint256(p, bs);
   ...
   * @return The number of bytes decoded
   */
  function _read_lendingDueTimestamp(uint p, bytes memory bs, Data memory r, uint[10] memory counters) internal pure returns (uint) {
    /**
     * if `r` is NULL, then only counting the number of fields.
     */
    (uint256 x, uint sz) = ProtoBufRuntime._decode_sol_uint256(p, bs);
   ...
   * @return The number of bytes decoded
   */
  function _read_interestAmount(uint p, bytes memory bs, Data memory r, uint[10] memory counters) internal pure returns (uint) {
    /**
     * if `r` is NULL, then only counting the number of fields.
     */
    (uint256 x, uint sz) = ProtoBufRuntime._decode_sol_uint256(p, bs);
   ...
   * @return The number of bytes decoded
   */
  function _read_collateralAmount(uint p, bytes memory bs, Data memory r, uint[10] memory counters) internal pure returns (uint) {
    /**
     * if `r` is NULL, then only counting the number of fields.
     */
    (uint256 x, uint sz) = ProtoBufRuntime._decode_sol_uint256(p, bs);
